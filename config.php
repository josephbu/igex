...
define('DETAIL_STRIP_POSITION', 'top'); // Image strip position on image view: 'top', 'bottom', or 'off'
...
define('IMAGE_FORMAT', 'webp'); // 'webp' Modern, high-compression, excellent for web use. 'jpg' Traditional format max compatibility.
